...
class HashVetorTest {
	...
	void testRemoverClienteSemColisao() {
		...
		assertEquals(22, tabelaHash.removerClienteCodigo(22).getCodigo());
		assertEquals(7, tabelaHash.removerClienteCodigo(7).getCodigo());
	...
	void testRemoverClienteComColisao() {
		...
		assertEquals(22, tabelaHash.removerClienteCodigo(22).getCodigo());
		assertEquals(7, tabelaHash.removerClienteCodigo(7).getCodigo());
		assertEquals(3645, tabelaHash.removerClienteCodigo(3645).getCodigo());
		assertEquals(511, tabelaHash.removerClienteCodigo(511).getCodigo());
		assertEquals(123, tabelaHash.removerClienteCodigo(123).getCodigo());

		assertNull(tabelaHash.buscarClienteCodigo(22));
		assertNull(tabelaHash.buscarClienteCodigo(7));
		assertNull(tabelaHash.buscarClienteCodigo(3645));
		assertNull(tabelaHash.buscarClienteCodigo(511));
